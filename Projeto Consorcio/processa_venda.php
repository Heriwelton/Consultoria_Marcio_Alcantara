<?php
	...
	try {
			...
			$mail->Username   = '/email que irá enviar/';                     //SMTP username
			...
			//Recipients
			$mail->setFrom('/email que irá receber/', 'MARCIO ALCANTARA - Consultor especializado');
			$mail->addAddress('/email que irá receber/');     //Add a recipient
